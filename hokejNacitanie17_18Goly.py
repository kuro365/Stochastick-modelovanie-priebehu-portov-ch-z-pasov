...
file_path = r'sezona17_18_goals.csv'
...
axs[2].grid(True)
# Názov celého grafu
plt.suptitle('Absolútne početnosti gólov v zápasoch sezóny 2017/2018', fontsize=25)
# Zobrazenie grafu
plt.tight_layout()
plt.show()
...
# Názov celého grafu
plt.suptitle('Relatívne početnosti gólov v zápasoch sezóny 2017/2018', fontsize=25)
...
# Načítanie údajov zo súboru CSV
file_path2 = r'C:\Users\Kurucovci\OneDrive\Marek\VŠ\BP\sezona17_18.csv'
