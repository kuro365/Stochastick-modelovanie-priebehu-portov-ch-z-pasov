...
file_path = r'sezona18_19_goals.csv'
...
axs[2].grid(True)
# Názov celého grafu
plt.suptitle('Absolútne početnosti gólov v zápasoch sezóny 2018/2019', fontsize=25)
# Zobrazenie grafu
plt.tight_layout()
plt.show()
...
# Názov celého grafu
plt.suptitle('Relatívne početnosti gólov v zápasoch sezóny 2018/2019', fontsize=25)
...
plt.xlabel('čas zápasu (s)')
plt.ylabel('Počet gólov')
plt.title('Rozdelenie gólov podľa času pri nerozhodnom stave v sezóne 2018/2019', fontsize=15)
plt.show()
...
plt.xlabel('čas zápasu (s)')
plt.ylabel('Počet gólov')
plt.title('Rozdelenie gólov podľa času pri gólovom rozdiele 1 v sezóne 2018/2019', fontsize=15)
plt.show()
...
plt.xlabel('čas zápasu (s)')
plt.ylabel('Počet gólov')
plt.title('Rozdelenie gólov podľa času gólovom rozdiele 2 a viac v sezóne 2018/2019', fontsize=15)
plt.show()
...
# Načítanie údajov zo súboru CSV
file_path2 = r'C:\Users\Kurucovci\OneDrive\Marek\VŠ\BP\sezona18_19.csv'
