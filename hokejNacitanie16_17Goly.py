...
file_path = r'sezona16_17_goals.csv'
...
# Filtrovanie údajov pre period = 1/2/3
...
axs[2].grid(True)
# Názov celého grafu
plt.suptitle('Absolútne početnosti gólov v zápasoch sezóny 2016/2017', fontsize=25)
# Zobrazenie grafu
plt.tight_layout()
plt.show()
...
# Názov celého grafu
plt.suptitle('Relatívne početnosti gólov v zápasoch sezóny 2016/2017', fontsize=25)
...
# Načítanie údajov zo súboru CSV
file_path2 = r'C:\Users\Kurucovci\OneDrive\Marek\VŠ\BP\sezona16_17.csv'
...
homeMatchGoals = data2['home_goals'].tolist()
awayMatchGoals = data2['away_goals'].tolist()
...
print("==================")
print("PARAMETRE")
cas_potrebny_na_gol_list = [None] * pocet_riadkov
for i in range (pocet_riadkov):
    if (goals_away_list[i] + goals_home_list[i] == 1):
        cas_potrebny_na_gol_list[i] = matchTime_list[i]
    else:
        cas_potrebny_na_gol_list[i] = matchTime_list[i] - matchTime_list[i-1]
print("vypise cas od posledneho golu", cas_potrebny_na_gol_list[:15])
print("priemerny cas v sekundach", sum(cas_potrebny_na_gol_list)/len(cas_potrebny_na_gol_list))
...
for i in range (pocet_riadkov2):
    for j in range (pocet_riadkov):
        if game_id_list2[i] == game_id_list[j]:
            if (diff_list[j] <= -4):
                naskok_m4_list.append(cas_potrebny_na_gol_list[j])
            if (diff_list[j] == -3):
                naskok_m3_list.append(cas_potrebny_na_gol_list[j])
            if (diff_list[j] == -2):
                naskok_m2_list.append(cas_potrebny_na_gol_list[j])
            if (diff_list[j] == -1):
                naskok_m1_list.append(cas_potrebny_na_gol_list[j])
            if (diff_list[j] == 0):
                naskok_0_list.append(cas_potrebny_na_gol_list[j])
            if (diff_list[j] == 1):
                naskok_p1_list.append(cas_potrebny_na_gol_list[j])
            if (diff_list[j] == 2):
                naskok_p2_list.append(cas_potrebny_na_gol_list[j])
            if (diff_list[j] == 3):
                naskok_p3_list.append(cas_potrebny_na_gol_list[j])
            if (diff_list[j] >= 4):
                naskok_p4_list.append(cas_potrebny_na_gol_list[j])
